...
EOS
  ...
  def test_the_shovel_operator_will_also_append_content_to_a_string
    hi = "Hello, "
    there = "World"
    hi << there  #add there to hi >> hi + there 
    assert_equal "Hello, World", hi
    assert_equal "World", there
  end
  ...
  def test_you_can_get_a_substring_from_a_string
    ...
    assert_equal "let", string[7,3] #from 7 take 3 
    assert_equal "let", string[7..9] #take from 7 to 9 including 9
  end
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, a           == b
    assert_equal false, a.object_id == b.object_id #different id
  end
end
