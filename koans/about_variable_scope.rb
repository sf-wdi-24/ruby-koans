...
class AboutVariableScope < Neo::Koan
  ...
  def test_block_variables_cannot_be_accessed_outside_scope
    ...
    assert_equal nil, defined? x     # x is in outside scope
  end
  ...
  def test_class_variable
    ...
    assert_equal 10, Mouse.count # 9 + 1 from earlier
  end
  ...
  def test_global_variables_can_be_accessed_from_any_scope
    assert_equal "Anywhere", $anywhere  # line 82
  end

  def test_global_variables_can_be_changed_from_any_scope
    # From within a method
    $anywhere = "Here"
    assert_equal "Here", $anywhere # line 91
  end
  ...
  def test_global_variables_can_be_changed_from_any_scope_2
    ...
    assert_equal "Hey", $anywhere #line 103
  end
